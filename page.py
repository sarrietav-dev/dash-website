...
groupby(["year_mes_factura", "trimestre", "year_factura", "tipo_tienda"]).sum() 

bd_grupo1 = bd_grupo1.reset_index()
bd_grupo1["vlr_neto_M"] = bd_grupo1["vlr_neto"] / 1000000 # Manejar la cifra en millones?
...
deltas_todo = pd.concat([pd.Series(bd_grupo1["year_mes_factura"].unique()), deltas_todo], axis = 1)
